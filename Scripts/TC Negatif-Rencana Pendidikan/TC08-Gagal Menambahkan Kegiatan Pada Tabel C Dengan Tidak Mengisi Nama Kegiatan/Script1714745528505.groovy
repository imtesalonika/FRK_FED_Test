...
WebUI.setText(findTestObject('Object Repository/Page_FRK  FED/input_Jumlah Mahasiswa Bimbingan_jumlah_mahasiswa (3)'), '2')

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/button_Simpan (22)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_FRK  FED/label_Nama Kegiatan (3)'), 0)
