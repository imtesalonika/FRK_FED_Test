...
WebUI.setText(findTestObject('Object Repository/Page_FRK  FED/input_Nama Kegiatan_nama_kegiatan (22)'), 'Mengajar Teori')

WebUI.setText(findTestObject('Object Repository/Page_FRK  FED/input_Jumlah Kelas Tatap Muka_jumlah_kelas (3)'), '2')

WebUI.setText(findTestObject('Object Repository/Page_FRK  FED/input_SKS Mata Kuliah_sks_matakuliah (4)'), '2')

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/button_Simpan (16)'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_FRK  FED/label_Jumlah Kelas Evaluasi'), 0)
