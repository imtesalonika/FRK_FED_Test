...
WebUI.click(findTestObject('Object Repository/Page_FRK  FED/a_Rencana Kerja (63)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/a_Rekap Kegiatan (101)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/i_Menunggu_bi bi-pencil-square (20)'))

WebUI.setText(findTestObject('Object Repository/Page_FRK  FED/input_Nama Kegiatan_nama_kegiatan (45)'), '')

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/button_Simpan Perubahan (43)'))

WebUI.rightClick(findTestObject('Object Repository/Page_FRK  FED/label_Nama Kegiatan (17)'))
