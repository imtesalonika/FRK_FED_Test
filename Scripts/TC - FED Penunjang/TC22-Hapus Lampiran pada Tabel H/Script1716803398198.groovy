...
WebUI.click(findTestObject('Object Repository/Page_FRK  FED/a_Evaluasi Diri (21)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/a_Rekap Kegiatan (201)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/a_Evaluasi Penunjang Lainnya (21)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/button_Tambah Lampiran (21)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/a_KUS2001_English_III_Week_15_Vocabulary_Qu_2181d3'))
