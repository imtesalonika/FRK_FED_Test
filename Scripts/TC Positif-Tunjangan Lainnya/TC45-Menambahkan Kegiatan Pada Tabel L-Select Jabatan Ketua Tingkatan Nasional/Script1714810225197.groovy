...
WebUI.click(findTestObject('Object Repository/Page_FRK  FED/a_Rencana Kerja (52)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/a_Rekap Kegiatan (83)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/b_Tunjangan Lainnya (40)'))

WebUI.click(findTestObject('Object Repository/Page_FRK  FED/button_Tambah Kegiatan (60)'))

WebUI.setText(findTestObject('Object Repository/Page_FRK  FED/input_Nama Kegiatan_nama_kegiatan (67)'), 'Ketua Pengurus Asosiasi')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_FRK  FED/select_Anggota                             _f3c399'), 
    'Ketua', true)
